"""
Django settings for sistema_concesionario project.
...
SECRET_KEY = 'django-insecure-%+in73ivo&_xn8$j+g^3@y15lk&#)wn#b7*coyq8hnxq%x0z=&'
...
ROOT_URLCONF = 'sistema_concesionario.urls'
